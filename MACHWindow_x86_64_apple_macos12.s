...
"-[MACHWindow setBlock_keyDown:]":
	...
	movq	_OBJC_IVAR_$_MACHWindow._windowKeyDown(%rip), %rcx
	movq	(%rbx,%rcx), %rdi
	movq	%rax, (%rbx,%rcx)
	popq	%rbx
...
"-[MACHWindow keyDown:]":
	...
	xorl	%eax, %eax
	callq	_NSLog
	movq	_OBJC_IVAR_$_MACHWindow._windowKeyDown(%rip), %rax
	movq	(%r14,%rax), %rdi
	testq	%rdi, %rdi
	je	LBB2_2
	movq	%rbx, %rsi
...
"-[MACHWindow .cxx_destruct]":
	...
	.cfi_startproc
	addq	_OBJC_IVAR_$_MACHWindow._windowKeyDown(%rip), %rdi
	xorl	%esi, %esi
