...
mv MACHAppDelegate_aarch64-macos.s MACHAppDelegate_arm64_apple_macos14.s
mv MACHAppDelegate_x86_64-macos.s MACHAppDelegate_x86_64_apple_macos14.s
...
mv MACHWindowDelegate_aarch64-macos.s MACHWindowDelegate_arm64_apple_macos14.s
mv MACHWindowDelegate_x86_64-macos.s MACHWindowDelegate_x86_64_apple_macos14.s
...
do
    ...
    zig cc -c MACHView.m \
        -target "$target" \
        -S -Os -fomit-frame-pointer  -fno-objc-exceptions -fobjc-arc \
        -o "$dst" \
        -iframework ./xcode-frameworks/Frameworks \
        -isystem ./xcode-frameworks/include
...
mv MACHView_aarch64-macos.s MACHView_arm64_apple_macos14.s
mv MACHView_x86_64-macos.s MACHView_x86_64_apple_macos14.s

for pair in \
    'MACHLayer_aarch64-macos.s aarch64-macos.14.0' \
    'MACHLayer_x86_64-macos.s x86_64-macos.14.0'
do
    dst=${pair%% *}
    target=${pair#* }

    zig cc -c MACHLayer.m \
        -target "$target" \
        -S -Os -fomit-frame-pointer  -fno-objc-exceptions -fobjc-arc \
        -o "$dst" \
        -iframework ./xcode-frameworks/Frameworks \
...
mv MACHLayer_aarch64-macos.s MACHLayer_arm64_apple_macos14.s
mv MACHLayer_x86_64-macos.s MACHLayer_x86_64_apple_macos14.s
