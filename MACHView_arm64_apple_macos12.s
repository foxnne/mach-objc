...
Lloh0:
	adrp	x8, _OBJC_IVAR_$_MACHView._windowKeyDown@PAGE
	ldp	x29, x30, [sp, #16]
Lloh1:
	ldrsw	x10, [x8, _OBJC_IVAR_$_MACHView._windowKeyDown@PAGEOFF]
	mov	x9, x0
	ldr	x8, [x19, x10]
	str	x9, [x19, x10]
	mov	x0, x8
...
Lloh4:
	adrp	x8, _OBJC_IVAR_$_MACHView._windowKeyDown@PAGE
Lloh5:
	ldrsw	x8, [x8, _OBJC_IVAR_$_MACHView._windowKeyDown@PAGEOFF]
	ldr	x0, [x20, x8]
	cbz	x0, LBB2_2
	ldr	x8, [x0, #16]
	mov	x1, x19
